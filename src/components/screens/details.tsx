...
const Details=()=>{
    ...
    if (!film) return(<div className='spinContainer '><Spinner animation="grow" variant="danger" /><Spinner animation="grow" variant="warning" /><Spinner animation="grow" variant="info" /></div>)

    const filmPath:string=`https://image.tmdb.org/t/p/w500${film.poster_path}`;
    return(
        <div className="container mt-5">
           <div className="col-12">
           <img src={filmPath}  className="img-fluid mx-auto d-block" alt="film.poster_path" />
           </div>
